    ...
    <div className="flex flex-col gap-6">
      {settled ? (
        ...
        >
          ...
          {challenges.length > 0 ? (
            <ul className="mt-2 flex flex-col gap-2 border-t border-emerald-200 pt-3 dark:border-emerald-900">
              {challenges.map((challenge) => (
                <li key={challenge.id} className="text-sm text-zinc-700 dark:text-zinc-300">
